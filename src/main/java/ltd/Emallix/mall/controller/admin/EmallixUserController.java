...
public class EmallixUserController {
    ...
    public String usersPage(HttpServletRequest request) {
        ...
        return "admin/Emallix_mall_user";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(EmallixMallUserService.getEmallixMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (EmallixMallUserService.lockUsers(ids, lockStatus)) {
