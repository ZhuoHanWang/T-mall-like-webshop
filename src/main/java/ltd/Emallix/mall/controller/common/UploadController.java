...
package ltd.Emallix.mall.controller.common;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException, IOException {
        ...
        try {
            ...
            resultSuccess.setData(EmallixMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
    ...
    public Result uploadV2(HttpServletRequest httpServletRequest) throws URISyntaxException, IOException {
        ...
        for (int i = 0; i < multipartFiles.size(); i++) {
            ...
            try {
                ...
                fileNames.add(EmallixMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
            } catch (IOException e) {
                e.printStackTrace();
                return ResultGenerator.genFailResult("文件上传失败");
            }
