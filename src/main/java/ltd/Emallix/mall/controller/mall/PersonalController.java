...
import ltd.Emallix.mall.util.MD5Util;
...
public class PersonalController {
    ...
    @Resource
    private EmallixMallUserService EmallixMallUserService;
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        String loginResult = EmallixMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        String registerResult = EmallixMallUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        EmallixMallUserVO mallUserTemp = EmallixMallUserService.updateUserInfo(mallUser, httpSession);
